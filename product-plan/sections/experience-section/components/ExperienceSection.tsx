...
// Animated letter component (shares logic with Hero but tailored for "Experience")
...
export function ExperienceSection({ experiences }: ExperienceSectionProps) {
  ...
  useEffect(() => {
    // Simple intersection observer for the reveal
  ...
  return (
    ...
    >
      {/* Vertical Background Lines (Complements Hero's horizontal ones) */}
