  ...
  return (
    ...
    >
      <a
        ...
        className="group relative block p-8 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 hover:border-lime-500/50 dark:hover:border-lime-400/50 transition-all duration-500 overflow-hidden"
      >
        ...
        <div className="flex items-center gap-6">
          <div className="p-4 bg-stone-50 dark:bg-stone-800 text-stone-400 dark:text-stone-500 group-hover:bg-lime-50 dark:group-hover:bg-lime-900/20 group-hover:text-lime-500 dark:group-hover:text-lime-400 transition-colors duration-500">
