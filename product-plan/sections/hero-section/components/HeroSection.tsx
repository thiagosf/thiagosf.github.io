...
function SocialIcon({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="p-3 rounded-none border border-white/20 text-stone-400 hover:border-lime-500 hover:text-lime-500 transition-all duration-300 hover:scale-105"
    >
