# Thiago Silva - Developer Portfolio — Product Overview
...
2. **Hero Section** — Animated hero section with introduction and tech stack
3. **Experience Section** — Professional roles and achievements showcase
4. **Projects Section** — Side projects showcase with descriptions
5. **Playground Section** — GitHub repositories integration and display
