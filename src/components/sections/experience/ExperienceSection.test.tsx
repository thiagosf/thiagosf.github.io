...
describe('ExperienceSection', () => {
    ...
    it('renders descriptions correctly', () => {
        ...
        expect(screen.getByText('Built the testing infrastructure.')).toBeInTheDocument();
    ...
    it('calls onItemClick when an item is clicked', () => {
        ...
        render(<ExperienceSection experiences={mockExperiences} onItemClick={onItemClick} />);
    ...
    it('calls onFilterTech when a tech chip is clicked', () => {
        ...
        render(<ExperienceSection experiences={mockExperiences} onFilterTech={onFilterTech} />);
