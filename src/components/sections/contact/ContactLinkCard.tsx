      ...
      >
        ...
        <Flex align="center" gap={6}>
          <div
            ...
            className="p-4 bg-stone-50 dark:bg-stone-800 text-stone-400 dark:text-stone-500 group-hover:bg-primary-50 dark:group-hover:bg-primary-900/20 group-hover:text-primary-500 dark:group-hover:text-primary-400 transition-colors duration-500"
          >
