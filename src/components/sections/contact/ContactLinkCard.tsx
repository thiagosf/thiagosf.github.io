import { type LucideIcon, Github, Linkedin, Twitter, Mail, Globe, ArrowUpRight } from 'lucide-react'
...
export function ContactLinkCard({
    ...
    const resolvedIconKey = Object.prototype.hasOwnProperty.call(iconMap, link.icon)
        ? link.icon
        : 'globe'
