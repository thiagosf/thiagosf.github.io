...
export function Card({ item, index, isVisible, variant }: CardProps) {
  ...
  return (
    <div
      className={`transition-all duration-700 group relative border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-8 hover:border-lime-500/50 dark:hover:border-lime-400/50 ${
