...
export function Card({
    ...
    return (
        <div
            className={`group relative border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 p-8 transition-all ${transitionDuration} hover:border-lime-500/50 dark:hover:border-lime-400/50 ${isVisible ? 'opacity-100 translate-y-0' : `opacity-0 ${translateY}`
                }`}
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <p className={`text-stone-600 dark:text-stone-400 leading-relaxed ${isPlayground ? 'text-sm' : ''} ${minHeight}`}>
                    {item.description}
                </p>
